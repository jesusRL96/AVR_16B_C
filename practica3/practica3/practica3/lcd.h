 ...
 * lcd.h
 *
 * Created: 20/08/2019 03:27:49 p. m.
 *  Author: jesus
 */ 
...
#ifndef LCD_H_
#define LCD_H_
// BIBLOTECA PARA EL MANEJO DE UN LCD EN MODO DE 4 BITS
#include <util/delay.h>
#include <inttypes.h>
#define LCD_PUERTO PORTB //Define el Puerto al cual van a ser conectados los pines del LCD
#define LCD_RS PB2       //Define el pin del Microcontrolador al cua se conecta el pin RS del LCD
#define LCD_E PB3        //Define el pin del Microcontrolador al cual se conecta el pin E del LCD
